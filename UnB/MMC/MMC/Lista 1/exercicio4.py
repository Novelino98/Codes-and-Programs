...
Glt1 = []
Eta_G1 = ((G_vidro/G_epoxi)- 1) / ((G_vidro/G_epoxi)+epsi)
for k in Vf:
    Glt1_posicao = G_epoxi*((1+(epsi*Eta_G1*k)) / (1-(Eta_G1*k)))  #Método analítico Halpin-Tsai para o mod. de cisalhamento
...
Glt2 = []
Eta_G2 = ((G_carbono/G_epoxi)- 1) / ((G_carbono/G_epoxi)+epsi)
for k2 in Vf:
    Glt2_posicao = G_epoxi*((1+(epsi*Eta_G2*k2)) / (1-(Eta_G2*k2)))  #Método analítico Halpin-Tsai para o mod. de cisalhamento
...
Glt3 = []
Eta_G3 = ((G_kevlar/G_epoxi)- 1) / ((G_kevlar/G_epoxi)+epsi)
for k3 in Vf:
    Glt3_posicao = G_epoxi*((1+(epsi*Eta_G3*k3)) / (1-(Eta_G3*k3)))  #Método analítico Halpin-Tsai para o mod. de cisalhamento
